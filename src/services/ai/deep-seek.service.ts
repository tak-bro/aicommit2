...
export class DeepSeekService extends AIService {
    ...
    constructor(protected readonly params: AIServiceParams) {
        ...
        this.serviceName = chalk.bgHex(this.colors.primary).hex(this.colors.secondary).bold(`[DeepSeek${this.formatModelSuffix()}]`);
        this.errorPrefix = chalk.red.bold(`[DeepSeek${this.formatModelSuffix()}]`);
