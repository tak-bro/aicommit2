...
export class HuggingFaceService extends AIService {
    ...
    constructor(protected readonly params: AIServiceParams) {
        ...
        this.serviceName = chalk.bgHex(this.colors.primary).hex(this.colors.secondary).bold(`[HuggingFace${this.formatModelSuffix()}]`);
        this.errorPrefix = chalk.red.bold(`[HuggingFace${this.formatModelSuffix()}]`);
    ...
    private async generateMessage(requestType: RequestType): Promise<AIResponse[]> {
        ...
        const { logging, generate, type, temperature, maxTokens, topP, timeout } = this.params.config;
