...
export class AnthropicService extends AIService {
    ...
    constructor(protected readonly params: AIServiceParams) {
        ...
        this.serviceName = chalk.bgHex(this.colors.primary).hex(this.colors.secondary).bold(`[Anthropic${this.formatModelSuffix()}]`);
        this.errorPrefix = chalk.red.bold(`[Anthropic${this.formatModelSuffix()}]`);
